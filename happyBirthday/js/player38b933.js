...
r._init=function(){
if(s.isSupport("HTML5")&&r._moCfg.bIsNote!=true)
{
...
if(!y.getURL()||((y.getURL().indexOf(v.url)==-1)&&y.getURL()!=v.hash))
{
debug(v.url);
...
u&&(u.title=B.join("\n"));
x&&(x.innerHTML=f.htmlEncode(j.getConnectingKernel().getInfo().title));
if(D=="play")
{
