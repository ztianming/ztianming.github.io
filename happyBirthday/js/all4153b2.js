...
setVerifyCallBack();
loadingBox({model:"\u9A8C\u8BC1\u7801",js:"$js_path$webp/qmverify29f984.js",oncheck:function(){
...
loadJsFileToTop(["$js_path$webp/com/kits/qmeditor/qqmail/release/editor40bcf4.js"]);
loadingBox({model:"\u53D1\u4FE1",js:["$js_path$webp/libcompose3e5857.js","$js_path$webp/qmaddrinput24e6ae.js"],oncheck:function(){
...
loadCssFile("$css_path$webp/login/addAccount327bfb.css",true,_oTop.document);
function N()
{
showInfo("\u53D1\u9001\u9A8C\u8BC1\u7801...");
...
{
cacheByIframe(a&&a.defcss==false?[]:[["css","",getRes("$css_path$webp/comm3b56cc.css")],["css",getPath("style"),"skin"]],extend({className:"menu_base_if",transparent:false,destroy:false},a,{win:b,header:["<script>",getTop.toString().replace(/[\r\n]/g,""),"<\/script>",a&&a.header||""].join(""),onload:function(c){
...
loadJsFile("$js_path$webp/qmlinkman2ae63a.js",true,e,b);
loadJsFile("$js_path$webp/qmaddress2f1957.js",true,e,b);
}
...
if(!b.QMPlayer)
{
loadJsFileToTop(["$js_path$webp/qmplayer/player38b933.js"]);
}
waitFor(function(){
return !!b.QMPlayer;
},function(c){
...
{
var b=getTop();
b.loadCssFile("$css_path$webp/webpushtip327bfb.css",true);
...
{
var b=getTop(),a=arguments.callee;
b.loadCssFile("$css_path$webp/login/addAccount327bfb.css",true,b.document);
...
if(!this._msVer)
{
var a=getTop().getRes("$css_path$webp/addAccountPtlogin412d4f.css"),b=(/addAccountPtlogin(.*)\.css/.test(a)&&RegExp.$1)||"";
this._msVer=b;
}
return this._msVer;
...
if(!this._msVer)
{
var a=getTop().getRes("$css_path$webp/qui_dialogPtlogin327bfb.css"),b=(/qui_dialogPtlogin(.*)\.css/.test(a)&&RegExp.$1)||"";
this._msVer=b;
}
return this._msVer;
},getDefaultCfg:function(){
...
c.loadCssFile("$css_path$webp/login/addAccount327bfb.css",true,c.document);
...
var e=this;
getTop().ptlogin2_onResize=a.ptlogin2OnResize(e);
getTop().ptloginResize();
e.S("geCancelBtn").onclick=function(){
e.close();
};
},onclose:function(){
if(this.reloadLeftWin)
...
var e=this;
e.S("importFrame")&&removeSelf(e.S("importFrame"));
}});
}
...
var a={'comm2010.css':'$css_path$webp/comm20103fb4e1.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};
